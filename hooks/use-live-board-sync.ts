      ...
      cards: [
        {
          ...
          description:
            "Create a modern, responsive landing page that showcases our product features and converts visitors into users.",
          assignedUsers: ["user_bob_smith"],
          reactions: [
            {
              emoji: "👍",
              count: 3,
              users: ["user_alice_johnson", "user_bob_smith"],
            },
        ...
        },
        {
          ...
          description:
            "Analyze customer surveys and interviews to identify pain points and improvement opportunities.",
          assignedUsers: ["user_alice_johnson"],
          reactions: [{ emoji: "🎉", count: 2, users: ["user_bob_smith"] }],
          commentCount: 0,
          createdBy: "user_bob_smith",
          createdAt: "2024-01-15T14:20:00Z",
          labels: [{ color: "bg-purple-500", name: "Research" }],
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          description:
            "Build secure user authentication with JWT tokens, password reset functionality, and social login options.",
          assignedUsers: ["user_alice_johnson"],
          reactions: [
      ...
      cards: [
        {
          ...
          description:
            "Initialize Git repository, set up CI/CD pipeline, configure development environment and documentation.",
          assignedUsers: ["user_bob_smith"],
          reactions: [
            {
              emoji: "✅",
          ...
          labels: [{ color: "bg-gray-500", name: "DevOps" }],
        },
      ],
    },
  ],
...
export function useLiveBoardSync() {
  const [localBoardData, setLocalBoardData] =
    useState<BoardData>(initialBoardData);
  ...
  const reorderLists = useCallback(
    (activeId: string, overId: string) => {
      updateBoardData((prev) => {
        const oldIndex = prev.lists.findIndex((list) => list.id === activeId);
        const newIndex = prev.lists.findIndex((list) => list.id === overId);
