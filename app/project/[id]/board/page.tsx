...
import { getProjectById } from "@/lib/project-manager"
...
export default function ProjectBoardPage() {
  ...
  const { boardData, isInitialized, addCard, deleteCard, moveCard, addList } = useLiveBoardSync(projectId)
  ...
  // Initialize user and project on client side only
  useEffect(() => {
  ...
  // Don't render until live sync is initialized and project is loaded
