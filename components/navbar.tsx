"use client"
import { Moon, Sun, Plus, ChevronDown, Menu, Home } from "lucide-react"
...
export function Navbar({ currentUser, onUserSwitch, boardTitle, projectId, onSidebarToggle }: NavbarProps) {
  ...
  return (
    <nav className="border-b bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-card/50">
      <div className="flex h-14 sm:h-16 items-center justify-between px-3 sm:px-6">
        {/* Left section - Sidebar toggle, breadcrumbs, and title */}
